...
def LSTM_MODEL(STOCK, output_text): 
   ...
   rmse = sqrt(mean_squared_error(merged_data[['Close']], merged_data[['Close_predicted']]))
   r2 = r2_score(merged_data[['Close']], merged_data[['Close_predicted']])
   accuracy = (1 - rmse / merged_data['Close'].mean()) * 100
